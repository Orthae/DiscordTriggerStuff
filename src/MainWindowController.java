...
//                 && trigger.getTriggerCategory().getValue().equals(tableSortingCategoryComboBox.getSelectionModel().getSelectedItem()
    ...
    public void findLogFolder() {
        ...
        if (log == null) {
            ...
            alert.setHeaderText(null);
            alert.setTitle(LanguageData.getInstance().getMsg("errorTitle"));
    ...
    public void voiceRRSTest() {
        if (VoiceRSS.getInstance().testTTS()) {
            Alert alert = new Alert(Alert.AlertType.INFORMATION);
            alert.setHeaderText(null);
            alert.setTitle(LanguageData.getInstance().getMsg("alertTitleNoError"));
            alert.setContentText(LanguageData.getInstance().getMsg("alertVoiceRRSWorks"));
            alert.show();
        } else {
            Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setTitle(LanguageData.getInstance().getMsg("errorTitle"));
            alert.setHeaderText(null);
            alert.setContentText(LanguageData.getInstance().getMsg("errorVoiceRRSNotWorking"));
            alert.show();
        }
    }
            ...
            TableCell<Trigger, String> cell = new TableCell<>() {
                ...
                public void updateItem(String item, boolean empty) {
                    if (empty) {
                        ...
                        button.setOnAction(event -> getTableRow().getItem().executeTrigger(true, tableDiscordPlaybackCheckBox.isSelected()));
                        setGraphic(button);
                    }
                }
            };
