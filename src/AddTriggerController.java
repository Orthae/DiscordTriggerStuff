...
//  EMD DPME
    ...
    public void playButton() {
        if (radioButtonBeep.isSelected()) {
            SoundManager.getInstance().playAudio(true, true, SoundManager.getInstance().DEFAULT_AUDIO_FILE);
            return;
        }
        if(triggerSoundDataTField.getText().isEmpty()){
            ...
            if (radioButtonTTS.isSelected()) {
                VoiceRSS.getInstance().requestTTS(triggerSoundDataTField.getText());
                SoundManager.getInstance().playAudio(true, true, Paths.get("sounds/" + Settings.getInstance().getTtsLanguage() + "_"
                        + triggerSoundDataTField.getText().toLowerCase().trim().replaceAll(" ", "_") + ".wav"));
            }
            if (radioButtonSoundFile.isSelected()) {
                SoundManager.getInstance().playAudio(true,true, Paths.get(triggerSoundDataTField.getText()));
            }
        }
    }
